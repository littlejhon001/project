...
if (isset($_REQUEST['cambiarClave'])) {
    ...
    $actualizar->ActualizarClave($_SESSION['cedula_usuario']);
...
<body>
    ...
    <div class="contenedor animate__animated animate__fadeInDown">
        ...
        <div class="contenedor1 caja1">
            ...
            <form action="actualizarClave.php" method="POST" class="formulario">

                <div class="caja2">
                    <label for="">Clave Actual:</label> <input type="text" name="clave" id="" required>
                    <label for="">Nueva Clave:</label> <input type="text" name="nuevaClave" id="" required>
                    <label for="">Confirmar Nueva Clave:</label> <input type="text" name="confirmarNuevaClave" id="" required>
                    <div class="Gperfil">
                        <input type="submit" class="btn" name="cambiarClave" value="Cambiar Clave">
                    </div>
                </div>
            </form>
        </div>
